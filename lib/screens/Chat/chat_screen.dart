...
class _ChatScreenState extends State<ChatScreen> {
  ...
  @override
  void initState() {
    print("initstate in chatscreen is called");
  ...
  void didChangeDependencies() {
    print("didchangedependency in chatscreen is called");
          ...
          children: [
            Consumer<ChatProvider>(builder:
              ...
              print(
                  "================================================================");
              print(
                  "THE ALL CHAT LENGTH IN CHATSCREEN IS ${value.allChats.length} ");
              if (value.allChats.isNotEmpty) {
                print(
                    "THE NEW CHAT LAST MESSAGE IN CHATSCREEN IS ${value.allChats[0].lastMessage.content} AND ${value.allChats[0].lastMessage.attachments.isEmpty}");
              }
              print(
                  "================================================================");
